...
import (
	...
	v1alpha1 "github.com/adityabhatia/kyma-op-poc/kyma-op/api/v1alpha1"
	"github.com/adityabhatia/kyma-op-poc/kyma-op/pkg/client/clientset/versioned/scheme"
...
// ClustersV1alpha1Client is used to interact with features provided by the clusters.kyma-project.io group.
type ClustersV1alpha1Client struct {
	restClient rest.Interface
}

func (c *ClustersV1alpha1Client) Kymas(namespace string) KymaInterface {
